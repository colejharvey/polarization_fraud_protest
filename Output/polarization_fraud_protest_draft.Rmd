...
The ECAV data is more comprehensive than the binary measure of protest included in the NELDA dataset; ECAV records 311 protested elections, while NELDA counts only 237. Since this is a count variable, I model it using negative binomial regression. In addition, since elections in this dataset are nested within countries, I include a model with fixed effects by country.   
